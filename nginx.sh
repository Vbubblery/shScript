...
./configure --prefix=$nginx_install_dir --user=$run_user --group=$run_user --with-threads --with-http_stub_status_module --with-http_v2_module --with-http_ssl_module --with-ipv6 --with-http_gzip_static_module --with-http_realip_module --with-http_flv_module --with-pcre=../pcre-$pcre_version --with-pcre-jit $malloc_module --with-debug --with-http_auth_request_module --with-http_addition_module --with-http_dav_module --with-http_sub_module --with-http_xslt_module --with-mail --with-mail_ssl_module --with-openssl=$oneinstack_dir/src/openssl-1.0.1j --with-zlib=$oneinstack_dir/src/zlib-1.2.8 --add-module=$oneinstack_dir/src/ngx_http_google_filter_module --add-module=$oneinstack_dir/src/ngx_http_substitutions_filter_module
